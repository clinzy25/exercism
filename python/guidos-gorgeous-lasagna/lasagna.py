...
def preparation_time_in_minutes(num_layers):
    ...
    an argument and returns how long it will take to prepare
...
def elapsed_time_in_minutes(number_of_layers, elapsed_bake_time):
    ...
    :param elapsed_bake_time: int - baking time already elapsed.
    :return: int - preparation time (in minutes) derived from the above parameters.

    Function that takes the number of layers of the lasagna and the elapsed bake time as
    an argument and returns the total elapsed cooking time including preparation time.
    """
